...
export default function PlanningPage() {
  ...
  return (
    <div className="planning-page">
      {/* Repère de build temporaire — app native uniquement, à retirer une fois
          la diffusion Play Store confirmée (voir src/lib/buildInfo.ts). */}
      {Capacitor.isNativePlatform() && (
        <div style={{
          background:'#DC2626', color:'#fff', fontWeight:800, fontSize:12.5,
          textAlign:'center', padding:'8px 12px', borderRadius:10, marginBottom:12,
          letterSpacing:'.03em',
        }}>
          {APP_BUILD_LABEL}
        </div>
