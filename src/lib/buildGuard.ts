...
// version de l'app (web ou WebView Android) reste figée sur des assets
// périmés après une mise à jour, indépendamment du cycle de vie normal du
// service worker (skipWaiting/clientsClaim déjà actifs côté Workbox).
