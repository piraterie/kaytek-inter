...
async function main() {
  ...
  console.log('[seed-local] OK — admin A, intervenant A, admin B (+ assistant A si défini) prêts (org A/B, abonnements actifs, clients + factures + connexions Google mock sur org A).')
}
