...
const pages = {
  '/i512': makeHtml(460,512), '/i192': makeHtml(172,192),
  '/i180': makeHtml(156,180), '/m512': makeHtml(492,512), '/m192': makeHtml(184,192)
}
http.createServer((q,r)=>{ const h=pages[q.url]; if(!h){r.writeHead(404);r.end();return} r.writeHead(200,{'Content-Type':'text/html;charset=utf-8'});r.end(h) })
  .listen(8765, ()=>{ console.log('READY:8765') })
